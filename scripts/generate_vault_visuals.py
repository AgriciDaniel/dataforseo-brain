...
<title id="title">DataForSEO Brain relationship map</title>
<desc id="desc">Source to memory to deliverable operating map.</desc>
<rect width="980" height="420" fill="#f8fafc"/>
<text x="40" y="58" font-size="28" font-family="Inter,Arial" font-weight="700" fill="#172033">DataForSEO Brain Relationship Map</text>
